...
\end{gather*}
Now, recall that $p(t,x_j\mid x_i)$ denotes the probability of travelling from state $x_i$ to the state $x_j$ in $t\in\N$ steps. By the Chapman-Kolmogorov equation (see \cite[Theorem~(7), \S6.1]{thr:kolmog}), $\l M^t\r_{ij}=p(t,x_j\mid x_i)$.
Therefore
\begin{align*}
